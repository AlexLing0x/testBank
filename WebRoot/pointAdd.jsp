...
<html>
  ...
  <body>
   <form  id="form1" name="form1" action="pointAction!add" method="post" >
		  ...
		  <li><label>知识点号</label><br><select name="point.pointNo" id="pCode" class="select_show">  
		    ...
		    <li><label>知识点名称</label><input name="point.pointName" id="name" type="text" class="dfinput" maxlength="30" placeholder="知识点名称"/></li>
		      ...
		      onchange="selSection()">  
					...
					<li><label>所属节</label><br><select name="point.sectionNo" id="sCode" class="select_show">  
							...
							<option value="${c.sectionNo}">第${c.sectionNo}节 ${c.sectionName}</option>
							</c:forEach>
						</select>
		   <br><br>
		    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
